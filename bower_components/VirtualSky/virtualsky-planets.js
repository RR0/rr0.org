...
(function ($) {
  ...
  function Planets() {
    ...
    this.planets = [{
      ...
      "magnitude": function (d) {
        return -0.36 + 5 * log10(d.r * d.R) + 0.027 * d.FV + 2.2E-13 * Math.pow(d.FV, 6)
      },
      "elements": [
        {
          "jd": 2456280.5,
      ...
      "magnitude": function (d) {
        return -4.34 + 5 * log10(d.a * d.R) + 0.013 * d.FV + 4.2E-7 * Math.pow(d.FV, 3)
      },
      "elements": [
        {
          "jd": 2456280.5,
      ...
      "magnitude": function (d) {
        return -1.51 + 5 * log10(d.r * d.R) + 0.016 * d.FV
      },
      "elements": [
        {
          "jd": 2450680.5,
      ...
      "magnitude": function (d) {
        return -9.25 + 5 * log10(d.r * d.R) + 0.014 * d.FV
      },
      "elements": [
        {
          "jd": 2456280.5,
      ...
      "magnitude": function (d) {
        return -7.15 + 5 * log10(d.r * d.R) + 0.001 * d.FV
      },
      "elements": [
        {
          "jd": 2456280.5,
      ...
      "magnitude": function (d) {
        return -6.90 + 5 * log10(d.r * d.R) + 0.001 * d.FV
      },
      "elements": [
        {
          "jd": 2456280.5,
  ...
  Planets.prototype.getHeliocentric = function (planet, jd, i) {
    ...
    return {
      xyz: this.heliocentric(v * this.d2r, r, p.p * this.d2r, p.o * this.d2r, p.i * this.d2r),
      M: M,
      v: v,
      r: r,
      i: i,
