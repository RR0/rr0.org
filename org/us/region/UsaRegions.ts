...
export const usaRegions = {
  ...
  Montana: usaRegion(UsaRegionCode.mo, Place.fromLocation(47.466667, 0.833333)),
  ...
  pennsylvania,
  PuertoRico: usaRegion(UsaRegionCode.pr, Place.fromLocation(47.466667, 0.833333)),
  ...
  VirginIslands: usaRegion(UsaRegionCode.vi, Place.fromLocation(47.466667, 0.833333)),
  washington,
