...
(function () {
  ...
  (function (M, ha) {
    ...
    function yg(a, b, c) {
      ...
      (($b = d),
        (d = Tc(pe, "onSelect")),
      d.length > 0 && ((b = new le("onSelect", "select", null, b, c)), a.push({
        event: b,
        listeners: d
      }), (b.target = qb))))
    }
      ...
      ti(() => {
        ...
        if ((b & 7) === 0) {
          ...
          if ((Ea = lj ? Ri(a, c) : Si(a, c))) {
            ...
            d.length > 0 && ((e = new mj("onBeforeInput", "beforeinput", null, c, e)), g.push({
              event: e,
              listeners: d
            }), (e.data = Ea))
          }
    ...
    function Qj(a, b) {
      ...
      if (d !== null) {
        ...
        if (q !== p && p && p.ownerDocument && wg(p.ownerDocument.documentElement, p)) {
          ...
          q = []
          for (u = p; (u = u.parentNode);) u.nodeType === 1 && q.push({
            element: u,
            left: u.scrollLeft,
            top: u.scrollTop
          })
