angular.module("matrix", []).service("resourceBundleService",function (e, a, n, f) {
    ...
    return g.promise
}).service("matrixService",function (e, a, n, f) {
    function h(a, b) {
        this.title = a;
        this.choices = {};
        this.index = b
    ...
    function g(a, b, m) {
        this.label = a;
        this.answerType = b;
        this.knownPhenomenaProbabilities =
            m;
        this.value = !1
    }
    ...
    n({method: "GET", url: "http://rr0.org/time/1/9/7/7/Poher_Matrice/matrix.json"}).success(function (q, b, r, k) {
        ...
        f.then(function (b) {
            ...
            for (d in q) {
                ...
                e.choices[f] = new g(b[l.question], l.answertype, l.knownPhenomenaProbabilities)
            }
    ...
    return{compute: function (a) {
        ...
        k = [];
        for (var h in b)g = b[h], g = a ? f - g : g, e = s[h], k[g] = k[g] ? k[g] + (", " + e) : e.charAt(0).toUpperCase() + e.slice(1);
        a = [];
        for (b = 0; b < k.length; b++)k[b] && a.push(k[b]);
        return a
    }}
}).controller("FormCtrl", ["$log",
        "$scope", "matrixService", function (e, a, n) {
            function f() {
                function g(a, b) {
                    this.type = a;
                    this.label = b
            ...
            a.onPrevious = function () {
                0 <=
                    a.questionIndex && (a.questionIndex--, f())
            };
            a.onNext = function () {
            ...
            a.compute = function (f) {
                ...
                a.explanations = n.compute("NonProbable" == a.resultsType);
