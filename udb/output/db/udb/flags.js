...
Flags.miscellaneousFlagsLabels = {
  SCI: {
    name: "Scientist",
...
Flags.typeOfUfoCraftFlagsLabels = {
  SCR: {
    name: "Saucer",
...
Flags.apparentUfoOccupantActivitiesLabels = {
  OBS: {
    name: "Observation",
...
Flags.placesVisitedAndThingsAffectedLabels = {
  NUC: {
    name: "Nuclear",
...
Flags.evidenceAndSpecialEffectsLabels = {
  PHT: {
    name: "Photos",
...
Flags.miscellaneousDetailsLabels = {
  MIL: {
